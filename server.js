...
app.post("/api/actions/upload/:id", upload.any("files"), async (req, res) => {
  var images = [];
...
app.get("/api/actions/recipes/:userId", async (req, res) => {
  const request = await sendQuery({
    query: `
...
app.get("/api/actions/recipe/:recipeId", async (req, res) => {
  const request = await sendQuery({
    query: `
...
// app.get("/api/actions/recipes/:id", async (req, res) => {
//   const request = await sendQuery({
//     query: `
//     {
//       recipes(where: {creator: {_eq: "${req.params.id}"}}) {
//         id
//         title
//         description
//         category
